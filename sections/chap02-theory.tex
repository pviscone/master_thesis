...
Furthermore, the inclusive and exclusive measurements of the $V_{cb}$ have always been incompatible and separated by $\approx 2 \sigma$ as shown in \Fig{fig:vcbvub} \\
...
\paragraph*{Decay of top quark pairs}
...
\end{itemize}
The branching ratio of the flavours of the $q\bar{q}$ pairs generated by \PW decays are given by the respective CKM elements.
\begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    ...
    \label{fig:pdf}
\end{figure}
To compute the inclusive $\ttbar$ production cross-section at an hadron collider, the parton-level cross-section has to be convolved with the PDFs
\begin{equation}
...
The emission of radiative gluons or quarks can cause the formation of collimated sprays of hadrons called jets (see sec. \ADDREF).\\
