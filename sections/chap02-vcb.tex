\newchap{The $|V_{cb}|$ CKM element}\label{chap:vcb}
\vspace{-1cm}
\minitoc
...
\begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.55\linewidth}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{fig//chap02-theory/vubvcb_upscayl_2x_remacri.png}
...
\paragraph*{Decay of W pairs}\hspace{0.1cm}\\
\begin{minipage}{\linewidth}
    \vspace{0.5cm}
