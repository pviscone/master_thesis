...
\end{enumerate}
There are other corrections, some of which are optional, like the flavor correction that corrects the jet energy scale separately for jets of different flavors, while others are applied only to the data and not to the MC samples.\\
...
\end{aligned}
\end{equation}
where $P(b), P(c),$ and $P(udsg)$ are respectively the b-tag, c-tag, and light flavor \DeepJet discriminators.
