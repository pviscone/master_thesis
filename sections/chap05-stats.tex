...
In this work, neural networks are used as a tool to classify different events in signal or background, giving to the input of the NN different features of the events (like the 4-vectors of the reconstructed particles in the event). So, in this section, the discussion will be focused on the classification problem.\\
\\
