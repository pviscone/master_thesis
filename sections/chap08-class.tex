...
The uncertainties on $|V_{cb}|$ are half of those on $|V_{cb}|^2$, so the expected relative uncertainty on $|V_{cb}|$ is 7.5\% ($7\%$ Stat. + $X\%$ Syst.)
\begin{equation*}
    |V_{cb}|=0.041 \pm 0.003
\end{equation*}
