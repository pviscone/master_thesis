...
\begin{minipage}{\linewidth}
    ...
    \end{minipage}
\end{minipage}
\footnotetext{These events are not included in the effective MC luminosity shown in tab \ADDREF. These are additional events used only to train and validate the network}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.48\textheight]{fig//chap09-sigback/muon_loss.png}
    \includegraphics[height=0.48\textheight]{fig//chap09-sigback/electron_loss.png}
